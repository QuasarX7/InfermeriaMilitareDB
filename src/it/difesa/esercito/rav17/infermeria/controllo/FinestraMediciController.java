...
import it.difesa.esercito.rav17.infermeria.modello.Medico;
...
public class FinestraMediciController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        campo.setText("");
        messaggio.setText("");
        colonna.setCellValueFactory(new PropertyValueFactory<>(it.difesa.esercito.rav17.infermeria.programma.Risorse.Modello.MEDICO));
    ...
    private void aggiungiMedico(ActionEvent event) {
        ...
        if(nuovoMedico != null){
            if(nuovoMedico.length() > 0){
                ...
                messaggio.setText(it.difesa.esercito.rav17.infermeria.programma.Risorse.Messaggi.NESSUN_VALORE_INSERITO);
            }
        }else{
            messaggio.setText(it.difesa.esercito.rav17.infermeria.programma.Risorse.Messaggi.NESSUN_VALORE_INSERITO);
        }
    ...
    private void rimuoviMedico(ActionEvent event) {
        ...
        if(id >= 0 && id < numeroElementi && _medico != null){
            ...
            messaggio.setText(it.difesa.esercito.rav17.infermeria.programma.Risorse.Messaggi.NESSUN_VALORE_SELEZIONATO);
        }
