...
import static it.difesa.esercito.rav17.infermeria.controllo.FinestraPrincipaleController.listaStoriaVaccinale;
import static it.difesa.esercito.rav17.infermeria.controllo.FinestraPrincipaleController.militare;
...
import static it.difesa.esercito.rav17.infermeria.programma.Risorse.SIGLA_VACCINAZIONI;
import static it.difesa.esercito.rav17.infermeria.programma.Risorse.VACCINAZIONI;
import it.difesa.esercito.rav17.infermeria.programma.Risorse.Vaccinazioni;
            ...
            for(String _profilassi: db.profilassi()){
                ...
                if(record != null){
                    listaStoriaVaccinale.add(new StoriaVaccinale(
                                    (String)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.PROFILASSI], 
                                    (Boolean)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.PREGRESSA], 
                                    (Boolean)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.PREGRESSA_DOC], 
                                    (String)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.VACCINAZIONE_CIVILE], 
                                    (String)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.VACCINAZIONE_MILITARE], 
                                    (String)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.SIGLA_TIPO_VACCINO], 
                                    (String)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.DOSE], 
                                    (DataOraria)record[it.difesa.esercito.rav17.infermeria.DaseDati.BASE_DATI.STORIA_VACCINALE.DATA_VACCINAZIONE]
                            )
                    );
                }
            }
