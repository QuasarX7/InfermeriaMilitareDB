...
import it.quasar_x7.infermeria.DaseDati.Dati;
...
import it.quasar_x7.infermeria.modello.Ricovero;
import it.quasar_x7.infermeria.modello.StoriaVaccinale;
import it.quasar_x7.infermeria.modello.Vaccinazione;
import it.quasar_x7.infermeria.modello.Verbale;
import it.quasar_x7.infermeria.modello.VisitaMedica;
import it.quasar_x7.infermeria.programma.Console;
...
import it.quasar_x7.infermeria.vista.FinestraDatiIncorporamento;
import it.quasar_x7.infermeria.vista.FinestraElencoMilitari;
import it.quasar_x7.infermeria.vista.FinestraGestioneUtenti;
...
//----------------------------------------------------------------------------------------------
    ...
    private void eliminaMilitare(ActionEvent event) {
        militare=tabellaMilitari.getSelectionModel().getSelectedItem();
        SwingUtilities.invokeLater(() -> {
            Object idoneo = Programma.datiMilitari.trovaMilitare(militare.getCognome(),militare.getNome(), militare.getNascita())[it.quasar_x7.infermeria.DaseDati.BASE_DATI.MILITARE.GML];
